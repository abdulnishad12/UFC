...
document.getElementById("Oslo").innerHTML = worldClock(1, "Europe")
...
document.getElementById("Singapore").innerHTML = worldClock(8, "Singapore")

setTimeout("worldClockZone()", 1000)
}
 
function validateLogin(){
	alert('Invalid user name or password. Please contact administrator.');
